                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        InputProps={{
                          ...
                          startAdornment: (
                            <InputAdornment position="start">
                              <GrUserPolice style={{ fontSize: '1.1rem', color: 'rgb(51 51 51 / 73%);', marginLeft: '0.3rem' }} />
                            </InputAdornment>
                          ),
                        }}
                      />
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        InputProps={{
                          ...
                          startAdornment: (
                            <InputAdornment position="start">
                              <TbCategoryFilled style={{ fontSize: '1.3rem', color: 'rgb(51 51 51 / 73%);', marginLeft: '0.3rem' }} />
                            </InputAdornment>
                          ),
                        }}
                      />
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        InputProps={{
                          ...
                          startAdornment: (
                            <InputAdornment position="start">
                              <FaShapes style={{ fontSize: '1.3rem', color: 'rgb(51 51 51 / 73%);', marginLeft: '0.3rem' }} />
                            </InputAdornment>
                          ),
                        }}
                      />
